...
## Active Work
- [x] feat(dj): Facebook + Twitter/X social adapters for listener shoutouts (issues #211, #212, feat/issue-211-212-social-adapters) | @claude-code | 2026-04-06 | Migrations: 040, 041
- [ ] feat(auth): real email reset + verification (issue #224, feat/issue-224-email-reset-verification) | @claude-code | 2026-04-06 | Migration: 042-043
